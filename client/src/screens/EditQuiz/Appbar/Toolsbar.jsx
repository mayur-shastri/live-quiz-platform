...
export default function Toolsbar({ isEditing, isSaving }) {
    ...
    const { View, play, stop, goToAndStop } = useLottie(syncAnimationOptions, { height: 50, width: 50 , speed: 5});
    ...
    //         <Lottie options={syncAnimationOptions} height={40} width={40} isStopped={!isSaving} speed={2}/>
    //         </div>
